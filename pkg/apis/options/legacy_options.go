...
type LegacyProvider struct {
	...
	AzureUseWorkloadIdentity bool     `flag:"azure-use-workload-identity" cfg:"azure_use_workload_identity"`
...
func legacyProviderFlagSet() *pflag.FlagSet {
	...
	flagSet.Bool("azure-use-workload-identity", false, "whether to use Azure AD App federated credential to access Azure from within Kubernetes")
...
func (l *LegacyProvider) convert() (Providers, error) {
	...
	provider.AzureConfig = AzureOptions{
		...
		UseWorkloadIdentity: l.AzureUseWorkloadIdentity,
	}
